 ...
 */
final class Version20220117162637 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE discussion (id INT AUTO_INCREMENT NOT NULL, author_id_id INT NOT NULL, titre VARCHAR(50) NOT NULL, created_at DATETIME NOT NULL, INDEX IDX_C0B9F90F69CCBE9A (author_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
