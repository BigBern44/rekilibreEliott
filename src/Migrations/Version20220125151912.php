 ...
 */
final class Version20220125151912 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie_discussion ADD role_requis LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE categorie_discussion DROP role_requis');
