 ...
 */
final class Version20200812145247 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE close_season (id INT AUTO_INCREMENT NOT NULL, close_date DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE registration_session (registration_id INT NOT NULL, session_id INT NOT NULL, INDEX IDX_90358072613FECDF (session_id), INDEX IDX_90358072833D8F43 (registration_id), PRIMARY KEY(registration_id, session_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('DROP TABLE close_season');
